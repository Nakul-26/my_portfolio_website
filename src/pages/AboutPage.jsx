...
// import { FaCode, FaReact, FaNodeJs, FaUnity, FaGit, FaGithub, FaAndroid, FaMicrosoft, FaUsers, FaComments, FaLightbulb, FaHandshake, FaGraduationCap, FaAward, FaJava, FaPython, FaJs, FaPalette } from 'react-icons/fa';
...
//     ],
//     "Problem-Solving": [
//         { name: 'Strong analytical and debugging skills', icon: <FaHandshake /> }
//     ],
//     "Teamwork & Collaboration": [
//         { name: 'Experience working in cross-functional teams and leading development tasks', icon: <FaUsers /> }
//     ],
// };
...
import { FaCode, FaReact, FaNodeJs, FaUnity, FaGit, FaGithub, FaAndroid, FaMicrosoft, FaUsers, FaComments, FaLightbulb, FaHandshake, FaGraduationCap, FaAward, FaJava, FaPython, FaJs, FaPalette, FaBrain, FaTools, FaProjectDiagram, FaUserFriends, FaRocket, FaBullseye } from 'react-icons/fa';
import profileImage from '../assets/profile.jpg';
import './AboutPage.css';
